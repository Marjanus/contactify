...
var _AppWrapper = __webpack_require__(28);

var _AppWrapper2 = _interopRequireDefault(_AppWrapper);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _reactDom.render)(_react2.default.createElement(_AppWrapper2.default, null), document.querySelector('#app'));
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'li',
                  null,
                  _react2.default.createElement('i', { className: 'fa fa-power-off', 'aria-hidden': 'true' }),
                  'Log out'
                )
              )
            )
...
var _FiltersBar = __webpack_require__(31);
...
var _ActiveContact = __webpack_require__(35);

var _ActiveContact2 = _interopRequireDefault(_ActiveContact);

var _contacts = __webpack_require__(36);
...
var Contacts = function (_Component) {
  ...
  _createClass(Contacts, [{
    ...
    value: function handleSortContacts() {
      var _this2 = this;

      this.setState({ sortedTable: true });
      var sortedContacts = this.state.visibleContacts.sort(function (a, b) {
        var nameA = a.name.toLowerCase();
        var nameB = b.name.toLowerCase();

        if (_this2.state.sortDirection === 'asc') {
          _this2.setState({ sortDirection: 'desc' });
          if (nameA < nameB) {
            return -1;
          }
          if (nameA > nameB) {
        ...
        _this2.setState({ sortDirection: 'asc' });
        if (nameA < nameB) {
          return 1;
        }
        if (nameA > nameB) {
    ...
    value: function renderActiveContact() {
      var _this3 = this;

      var activeItem = this.state.allContacts.filter(function (contact) {
        return contact.id === _this3.state.activeId;
      })[0];

      return _react2.default.createElement(_ActiveContact2.default, {
    ...
    key: 'renderVisibleContacts',
    value: function renderVisibleContacts() {
      var _this4 = this;

      return this.state.visibleContacts.map(function (item) {
        return _react2.default.createElement(_Contact2.default, {
          key: item.id,
          activeRow: _this4.state.activeId,
          id: item.id,
          active: item.active,
          name: item.name,
          ...
          email: item.email,
          phone: item.phone,
          onSetActiveContact: _this4.handleSetActiveContact
        });
      });
    }
  }, {
    key: 'render',
    value: function render() {
      var sortArrow = this.state.sortDirection === 'asc' ? _react2.default.createElement('i', { className: 'fa fa-arrow-down', 'aria-hidden': 'true' }) : _react2.default.createElement('i', { className: 'fa fa-arrow-up', 'aria-hidden': 'true' });
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'button',
              { type: 'button', className: 'add-contact' },
...
var Contact = function Contact(props) {
  var rowClass = props.id === props.activeRow ? 'active-row' : 'row';
  var isVisible = props.active ? _react2.default.createElement('i', { className: 'fa fa-eye', 'aria-hidden': 'true' }) : _react2.default.createElement('i', { className: 'fa fa-eye-slash', 'aria-hidden': 'true' });
  var editIcon = _react2.default.createElement('i', { className: 'fa fa-pencil', 'aria-hidden': 'true' });
  var deleteIcon = _react2.default.createElement('i', { className: 'fa fa-trash', 'aria-hidden': 'true' });

  return _react2.default.createElement(
    'tr',
    { className: rowClass, 'data-id': props.id, onClick: props.onSetActiveContact },
    _react2.default.createElement(
      'td',
      null,
      isVisible,
...
Contact.propTypes = {
  ...
  activeRow: _propTypes2.default.number.isRequired,
  ...
  onSetActiveContact: _propTypes2.default.func.isRequired
};
...
var ActiveContact = function ActiveContact(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement('img', { src: 'src/utils/userpic.jpg', alt: 'User' })
    ),
    _react2.default.createElement(
      'div',
...
exports.default = ActiveContact;

/***/ }),
/* 36 */
/***/ (function(module, exports) {

module.exports = [{"id":1,"name":"Nina","surname":"Palmer","city":"London","email":"nina@gmail.com","phone":"+44 20 7946 0964","active":true},{"id":2,"name":"Jeff","surname":"Brooks","city":"Sydney","email":"jeff.brooks@gmail.com","phone":"+61 1900 654 321","active":false},{"id":3,"name":"Anthony","surname":"Hill","city":"Los Angeles","email":"a.hill@gmail.com","phone":"+1 213 509 6995","active":true},{"id":4,"name":"Shannon","surname":"Hunt","city":"Singapore","email":"s.hunt@gmail.com","phone":"+65 84624113","active":true},{"id":5,"name":"Ryan","surname":"Conner","city":"Hong Kong","email":"ryan@gmail.com","phone":"+852 3772 3361","active":true},{"id":6,"name":"Carol","surname":"Caldwell","city":"Hong Kong","email":"c.c@gmail.com","phone":"+852 2153 9983","active":false},{"id":7,"name":"Keith","surname":"Spencer","city":"London","email":"k.spencer@hotmail.com","phone":"+44 20 7946 0145","active":true},{"id":8,"name":"Stanley","surname":"Reese","city":"Sydney","email":"stanley.reese@gmail.com","phone":"+61 1900 654 321","active":true}]
